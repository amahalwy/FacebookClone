...
class ProfileButton extends React.Component {
  ...
  render() {
    ...
    } else if ((this.props.user.requestsAsReceiver) && (this.props.user.requestsAsReceiver.some(user => user.requestor_id === this.props.currentUser.id )) ) { // if (this.props.currentUser.requestsSent)
      return (
        <button className='edit-profile-button'>
            Requested
        </button>
      )  
    } else if ((this.props.user.friendships) && (this.props.user.friendships.some(user => user.friend_id === this.props.currentUser.id)) ) {
      return (
        < button className='edit-profile-button'>
